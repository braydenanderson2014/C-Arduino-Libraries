...
void setup() {
  ...
  RUN_TEST(test_addFloat);

  RUN_TEST(test_addAllInt);
  RUN_TEST(test_addAllString);
  RUN_TEST(test_addAllFloat);

  RUN_TEST(test_removeInt);
  RUN_TEST(test_removeString);
  RUN_TEST(test_removeFloat);

  RUN_TEST(test_clearInt);
  RUN_TEST(test_clearString);
  RUN_TEST(test_clearFloat);

  RUN_TEST(test_sizeInt);
  RUN_TEST(test_sizeString);
  RUN_TEST(test_sizeFloat);

  RUN_TEST(test_containsInt);
  RUN_TEST(test_containsString);
  RUN_TEST(test_containsFloat);
