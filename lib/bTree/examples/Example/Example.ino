...
void setup(){
    ...
    //Search for a key
    BTreeNode<double>* result = tree.search(tree.getRoot(), 6); //Search for the key 6 in the tree. If the key is found, the function will return the node containing the key. If the key is not found, the function will return nullptr.
    if (result != nullptr) {
