...
- Library role: Probe agent that exports diagnostics to server and UnoQ backends

## UnoQ Experimental Status

- This copy is maintained in the UnoQ experimental folder.
- Added UnoQ bridge export API:
  - `uploadSnapshotsToUnoQ(UnoQFileTransferClient&, const String& basePath)`
- Added filesystem snapshot export API:
  - `saveSnapshotsToFilesystem(fs::FS&, const String& basePath)`
- Supports reporting diagnostics/results payloads for Linux-side ingestion.
