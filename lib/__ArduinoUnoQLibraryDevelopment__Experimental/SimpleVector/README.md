...
- Library role: Core vector dependency used by UnoQ experimental libraries

## UnoQ Experimental Status

- This copy is included in the UnoQ experimental folder as a shared dependency.
- It is used by MemoryManager, Properties, DynamicStorageLibrary, and JSON internals.
- Core SimpleVector APIs are unchanged in this branch; documentation here reflects dependency alignment for UnoQ testing.
