...
- Library role: Key/value configuration store for SD, LittleFS, and UnoQ backend flows

## UnoQ Experimental Status

- This copy is maintained in the UnoQ experimental folder.
- SD and LittleFS support remain available through `Properties::begin(...)` overloads.
